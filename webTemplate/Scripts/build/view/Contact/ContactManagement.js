...
define(["require", "exports", "vue-property-decorator", "./service", "moment", "../Share/FilterFunction"], function (require, exports, vue_property_decorator_1, service_1, moment, FilterFunction_1) {
    ...
    var ContactManagement = (function (_super) {
        ...
        ContactManagement.prototype.OnPerPageChange = function () {
            this.SetSendPagination();
        };
        ContactManagement.prototype.OnCurrentPageChange = function () {
            this.SetSendPagination();
        };
        ...
        ], ContactManagement.prototype, "OnPerPageChange", null);
        __decorate([
            vue_property_decorator_1.Watch('CurrentPage')
        ], ContactManagement.prototype, "OnCurrentPageChange", null);

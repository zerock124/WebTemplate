...
define(["require", "exports", "vue-property-decorator", "./service", "moment", "../Share/FilterFunction"], function (require, exports, vue_property_decorator_1, service_1, moment, FilterFunction_1) {
    ...
    var BackOperationManagement = (function (_super) {
        ...
        BackOperationManagement.prototype.OnPerPageChange = function () {
            this.SetSendPagination();
        };
        BackOperationManagement.prototype.OnCurrentPageChange = function () {
            this.SetSendPagination();
        };
        ...
        ], BackOperationManagement.prototype, "OnPerPageChange", null);
        __decorate([
            vue_property_decorator_1.Watch('CurrentPage')
        ], BackOperationManagement.prototype, "OnCurrentPageChange", null);
